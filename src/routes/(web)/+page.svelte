...
<div class="page">
  <div class="flex flex-col">
    ...
    <div class="flex self-center gap-5 pt-5 pb-14">
      {#each recents as _}
        <div class="group w-14 h-14 p-2 cursor-pointer relative rounded-2xl bg-white bg-opacity-20">
          <img src="https://svgl.vercel.app/library/google-idx.svg" alt="" class="">
          <h3 class="absolute hidden group-hover:block text-sm top-16 left-2/4 translate-x-[-50%]">Google&nbsp;IDX</h3>
        </div>
      {/each}
    </div>
    <form class="self-center flex shadow-primary rounded-2xl">
      <div class="flex items-center gap-3 pr-3 pl-4 bg-appdark bg-opacity-50 rounded-l-2xl">
