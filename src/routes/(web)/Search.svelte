...
<form class="self-center flex shadow-2xl rounded-2xl border border-content-200 dark:border-content-700">
  <button class="flex items-center gap-3 relative pr-3 pl-4 bg-content-100 dark:bg-content-950 bg-opacity-50 rounded-l-2xl" on:click={()=>{categorysVisible=true}}>
    ...
    <!-- categorys -->
    <div class="categorys absolute top-14 left-0 bg-content-50 dark:bg-content-900" use:clickOutside on:clickOutside={()=>{categorysVisible=false}}>
      <div class="cat" class:hidden={!categorysVisible}>
